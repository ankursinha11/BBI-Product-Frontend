        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-white">
              Set up a new database schema from scratch.
            </p>
          </Card>
          <Card
            className="p-6 bg-white/5 backdrop-blur-lg border-white/10 hover:bg-white/10 transition-all duration-300 shadow-lg hover:shadow-xl cursor-pointer"
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-white">
                Upload a JSON file with schema details.
              </p>
            </Card>
          </div>
          ...
          {entryMethod === "file" && (
            <div className="space-y-4">
              ...
              />
              {file && (
                <p className="text-green-300">File uploaded: {file.name}</p>
              )}
            </div>
          )}
          ...
          {entryMethod === "manual" && (
            <div className="space-y-6">
              {manualEntries.map((entry, index) => (
                <Card
                  key={index}
                  className="p-4 bg-white/5 backdrop-blur-lg border-white/10"
                >
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        value={entry.name}
                        onChange={(e) =>
                          handleManualEntryChange(index, "name", e.target.value)
                        }
                        className="bg-white/5 border-white/10 text-white"
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        value={entry.type}
                        onChange={(e) =>
                          handleManualEntryChange(index, "type", e.target.value)
                        }
                        className="bg-white/5 border-white/10 text-white"
                      />
                    </div>
